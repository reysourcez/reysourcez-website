/* ============================================================
   ...
   Version: v4.0-scratch-rebuild - 2026-09-20
   ============================================================ */
...
async function scanForm(imageBase64, note) {
  ...
  // Defensive Text Reading to eliminate "Unexpected token '<'" parsing errors
...
async function runScan() {
  if (!currentImageBase64) return setStatus('Select an image file first.', true);
  ...
  try {
    ...
    if (!result.recognized) return setStatus('Form format unrecognized. Try taking a clearer photo.', true);
